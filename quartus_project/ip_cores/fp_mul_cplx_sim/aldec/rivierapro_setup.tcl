...
# ACDS 20.1 720 win32 2023.04.23.13:28:28
# ----------------------------------------
...
# ----------------------------------------
# If fp_mul_cplx is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "fp_mul_cplx"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fp_mul_cplx.vo"
}
